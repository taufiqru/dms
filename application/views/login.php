...
<head>
  ...
  <title>Repositori PT Bukit Asam Tbk | Log in</title>
  ...
  <style type="text/css">
    ...
    html { 
      background: url(<?=base_url()?>img/2.jpg) no-repeat center center fixed; 
...
<div class="login-box animated fadeInDown" style="background:white;">
  ...
  <img src="<?=base_url()?>/img/logo.png"><br><br>
    <a href="#">Repositori <br>PT Bukit Asam Tbk </a>
  </div>
  <!-- /.login-logo -->
